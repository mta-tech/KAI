...
# ============================================================================
# Context Platform Request Models
# ============================================================================


class ContextAssetRequest(BaseModel):
    """Request to create a new context asset."""

    db_connection_id: str
    asset_type: str  # "table_description", "glossary", "instruction", "skill"
    canonical_key: str
    name: str
    content: dict
    content_text: str
...
class UpdateContextAssetRequest(BaseModel):
    """Request to update an existing context asset (DRAFT only)."""
...
class PromoteAssetRequest(BaseModel):
    """Request to promote an asset to the next lifecycle state."""

    promoted_by: str
    change_note: str | None = None


class DeprecateAssetRequest(BaseModel):
    """Request to deprecate a published asset."""
...
class CreateDraftRevisionRequest(BaseModel):
    """Request to create a draft revision of an existing asset."""

    author: str


class SearchContextAssetsRequest(BaseModel):
    """Request to search context assets."""

    db_connection_id: str
    query: str
    asset_type: str | None = None  # Optional filter by asset type
    limit: int = 10
