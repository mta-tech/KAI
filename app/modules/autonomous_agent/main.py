...
def create_connection(connection_uri: str, alias: str, schemas: tuple, metadata: str):
    ...
    Examples:
        ...
        kai create-connection "postgresql://user:pass@localhost:5432/mydb" -a my_database

        kai create-connection "postgresql://user:pass@host:5432/db" -a prod_db -s public -s analytics

        kai create-connection "csv://data.csv" -a sales_data
    """
    # Check Typesense first
    if not ensure_typesense_or_prompt(required=True):
        return
