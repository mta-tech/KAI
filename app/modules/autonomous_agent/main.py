...
# Memory Commands
# =============================================================================
# Memory commands have been moved to: app/modules/autonomous_agent/cli/knowledge.py
# Use: kai knowledge memory <command>
# Available commands: list, show, search, add, delete, clear, namespaces
@cli.command()
